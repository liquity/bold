...
import {ITokenPriceFeed} from "../Interfaces/IMainnetPriceFeed.sol";
import "../BorrowerOperations.sol";

abstract contract CollateralPriceFeedBase is ITokenPriceFeed, Ownable {
    ...
    constructor(address _owner, address _tokenUsdOracleAddress, uint256 _oracleStalenessThreshold) Ownable(_owner) {
        // Store Token-USD oracle
        tokenUsdOracle.aggregator = AggregatorV3Interface(_tokenUsdOracleAddress);
        tokenUsdOracle.stalenessThreshold = _oracleStalenessThreshold;
