...
contract KINGPriceFeed is TokenPriceFeedBase {
   constructor(address _owner, address _kingUsdOracleAddress, uint256 _kingUsdStalenessThreshold)
        TokenPriceFeedBase(_owner, _kingUsdOracleAddress, _kingUsdStalenessThreshold)
    {
        _fetchPricePrimary();
    ...
    function _fetchPricePrimary() internal returns (uint256, bool) {
        ...
        // If the KING-USD Chainlink response was invalid in this transaction, return the last good KING-USD price calculated
