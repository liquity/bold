...
contract yETHPriceFeed is TokenPriceFeedBase {
   constructor(address _owner, address _yEthUsdOracleAddress, uint256 _yEthUsdStalenessThreshold)
        TokenPriceFeedBase(_owner, _yEthUsdOracleAddress, _yEthUsdStalenessThreshold)
    {
        _fetchPricePrimary();
