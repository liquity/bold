...
contract InterestRateAggregate is DevTestSetup {
    ...
    function testBatchLiquidateTrovesPureOffsetChangesAggRecordedInterestCorrectly() public {
        ...
        assertEq(uint8(troveManager.getTroveStatus(CTroveId)), uint8(ITroveManager.Status.unredeemable));
        assertEq(uint8(troveManager.getTroveStatus(DTroveId)), uint8(ITroveManager.Status.unredeemable));
