...
contract DeployGovernance is Script, Deployers {
    ...
    function deployGovernance(address _deployer, bytes32 _salt, IERC20 _boldToken, IERC20 _usdc) internal {
        ...
        // Uni V4 initiative
        deployUniV4Donations(governanceAddress);

        // Curve initiative
        deployCurveV2GaugeRewards(governanceAddress);
    ...
    function deployUniV4Donations(address _governanceAddress) private {
    ...
    function deployCurveV2GaugeRewards(address _governanceAddress) private {
