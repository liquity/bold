  ...
  describe("Stability Pool Withdrawal", async () => {
    ...
    */
    ...
    it("withdrawFromSP(): 2 depositors can withdraw after each receiving half of a pool-emptying liquidation", async () => {
      ...
      const SPLUSDBalance_1 = await boldToken.balanceOf(stabilityPool.address)
      ...
      // Check SP LUSD balance is zero
      const SPLUSDBalance_2 = await boldToken.balanceOf(stabilityPool.address)
      ...
      // Check SP LUSD balance is zero
      const SPLUSDBalance_3 = await boldToken.balanceOf(stabilityPool.address)
    ...
    it("withdrawFromSP(): Large liquidated coll/debt, deposits and ETH price", async () => {
      ...
      // Check LUSD balances
      const aliceLUSDBalance = await boldToken.balanceOf(alice)
      ...
      const bobLUSDBalance = await boldToken.balanceOf(bob)
