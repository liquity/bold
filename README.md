...
- [Supplying Hints to Trove operations](#supplying-hints-to-trove-operations)
 - [Trove operation without a hint](#trove-operation-without-a-hint)
 - [Trove operation with hints](#trove-operation-with-hints)
 - [Example openTrove transaction with hints](#example-opentrove-transaction-with-hints)
...
- [Redemption warning](#redemption-warning)
- [Zombie Troves](#zombie-troves)
 - [Full Zombie Troves logic](#full-zombie-troves-logic)
 - [Special case: redemptions and `lastZombieTroveId`](#special-case-redemptions-and-lastzombietroveid)
 - [Rationale for `lastZombieTroveId`](#rationale-for-lastzombietroveid)
...
- [Minimum 1 BOLD token in the SP](#minimum-1-bold-token-in-the-sp)
...
- [Delegation](#delegation)
 ...
 - [Buffer Collateral Ratio (BCR)](#buffer-collateral-ratio-bcr)
...
- [Oracles in Liquity v2](#oracles-in-liquity-v2)
 ...
 - [Is the "worst price" approach sufficient to mitigate front-running?](#is-the-worst-price-approach-sufficient-to-mitigate-front-running)
...
- [Known issues and mitigations](#known-issues-and-mitigations)
 ...
 - [26 - Debt in front should not include Troves at the same interest rate](#26---debt-in-front-should-not-include-troves-at-the-same-interest-rate)
