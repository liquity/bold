...
- [What remains the same in v2 from v1](#what-remains-the-same-in-v2-from-v1)
  ...
  - [Redemption fee mechanics at branch level](#redemption-fee-mechanics-at-branch-level)
  ...
  - [Aggregate (branch level) overcollateralization](#aggregate-branch-level-overcollateralization)
...
- [Stability Pool implementation](#stability-pool-implementation)
  - [Deposits and ETH gains](#how-deposits-and-eth-gains-are-calculated)
...
- [Known issues and mitigations](#known-issues-and-mitigations)
  - [Oracle price frontrunning](#1---oracle-price-frontrunning)
  - [Bypassing redemption routing logic](#2---bypassing-redemption-routing-logic)
  - [Path-dependent redemptions](#3---path-dependent-redemptions)
  - [Oracle failure impact](#4---oracle-failure-and-urgent-redemptions-with-the-frozen-last-good-price)
  - [Stale oracle price](#5---stale-oracle-price-before-shutdown-triggered)
  - [Batch management operations during shutdown](#6---batch-management-ops-dont-check-for-a-shutdown-branch)
  - [Aggregate and individual debt discrepancies](#7---discrepancy-between-aggregate-and-sum-of-individual-debts)
  - [Stability Pool yield gains discrepancy](#8---discrepancy-between-yieldgainsowed-and-sum-of-individual-yield-gains-in-stabilitypool)
  - [LST oracle risks](#9---lst-oracle-risks)
  - [Branch shutdown and bad debt](#10---branch-shutdown-and-bad-debt)
  - [Average branch interest rate calculation](#11---inaccurate-calculation-of-average-branch-interest-rate)
  - [Batch manager interest rate adjustment](#12---trovemanager-can-make-troves-liquidatable-by-changing-the-batch-interest-rate)
  - [Trove adjustment griefing](#13---trove-adjustments-may-be-griefed-by-sandwich-raising-the-average-interest-rate)
  - [SP reward compounding](#14---stability-pool-claiming-and-compounding-yield-can-be-used-to-gain-a-slightly-higher-rate-of-rewards)
  - [Urgent redemptions ICR impact](#15---urgent-redemptions-premium-can-worsen-the-icr-when-trove-coll-value--debt-value-1)
