...
import { addressesEqual, IconExternal, InfoTooltip, Tabs } from "@liquity2/uikit";
    ...
    >
      ...
      >
        ...
        <div>
          ...
          {isOwner && (
            <>
              You can claim back the excess collateral across your liquidated {collToken.name} loans on your{" "}
              <LinkTextButton href="/" label="Dashboard" />.
            </>
          )}
        </div>
      </section>
