...
export function PanelUpdateLeveragePosition({
  ...
  const allowSubmit =
    ...
    newLoanDetails.debt &&
    dn.gt(newLoanDetails.debt, MIN_DEBT);
        ...
        <Field
          field={
            <LeverageField
              ...
              drawer={
                newLoanDetails.debt && dn.lt(newLoanDetails.debt, MIN_DEBT)
                  ? {
                      mode: "error",
          ...
          footer={[
            {
              start: <Field.FooterInfo label='ETH liquidation price' />,
                ...
                <ValueUpdate
                  fontSize={14}
                  before={fmtnum(initialLoanDetails.liquidationPrice, {
                    preset: "2z",
                    prefix: "$",
                  })}
                  after={
          ...
          newLoanDetails.status === "liquidatable" ? (
            ...
            <WarningBox>
              <div>
                ...
                position is {fmtnum(newLoanDetails.maxLtv, "pct2z")}%. Your
          ...
          onClick={() => {
            if (account.address) {
              txFlow.start({
                ...
                depositChange:
                  !depositChange.parsed || dn.eq(depositChange.parsed, 0)
                    ? null
                    : dn.mul(
                        depositChange.parsed,
                        depositMode === "remove" ? -1 : 1
                      ),
