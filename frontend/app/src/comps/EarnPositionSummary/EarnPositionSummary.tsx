...
export function EarnPositionSummary({
  ...
  const active =
    txPreviewMode ||
    Boolean(earnPosition?.deposit && dn.gt(earnPosition.deposit, 0));
    ...
    collToken && (
      ...
      >
        ...
        >
          ...
          >
            <TokenIcon symbol={collToken.symbol} size={34} />
          </div>
          <div
            className={css({
              flexGrow: 1,
          ...
          >
            ...
            >
              <div>{title ?? `${collToken.name} Stability Pool`}</div>
              <div
                className={css({
                  display: "flex",
                  gap: 4,
