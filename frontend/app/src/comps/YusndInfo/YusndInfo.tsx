...
export function YusndInfo({
  ...
  conversion: {
    mode: "deposit";
    usndAmount: Dnum;
    yusndAmount: Dnum | null;
  } | {
    mode: "redeem";
    usndAmount: Dnum | null;
    yusndAmount: Dnum;
  };
  loading: boolean;
}) {
  ...
  const usnd = (
    <TokenAmount
      symbol="USND"
      animate={false}
      value={conversion.usndAmount}
      fallback={loading ? "… USND" : "− USND"}
      suffix=" USND"
    />
  );
  ...
  const yusnd = (
    <TokenAmount
      symbol="YUSND"
      animate={false}
      value={conversion.yusndAmount}
      fallback={loading ? "… yUSND" : "− yUSND"}
      suffix=" yUSND"
    />
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <ValueUpdate
            before={conversion.mode === "deposit" ? usnd : yusnd}
            after={conversion.mode === "deposit" ? yusnd : usnd}
          />
        </div>
      </div>
      <ul
