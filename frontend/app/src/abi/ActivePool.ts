...
export const ActivePool = [
  ...
  { "type": "function", "name": "delegateTokens", "inputs": [], "outputs": [], "stateMutability": "nonpayable" },
  {
    "type": "function",
    "name": "getBoldDebt",
    "inputs": [],
  ...
  {
    "type": "function",
    "name": "setDelegateRepresentative",
    "inputs": [{ "name": "_delegateRepresentative", "type": "address", "internalType": "address" }],
    "outputs": [],
    "stateMutability": "nonpayable",
  },
  {
