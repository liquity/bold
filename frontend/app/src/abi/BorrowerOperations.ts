...
export const BorrowerOperations = [
  ...
  },
  {
    ...
    "outputs": [{
      ...
      "components": [{ "name": "account", "type": "address", "internalType": "address" }, {
  ...
  { "type": "error", "name": "BelowCriticalThreshold", "inputs": [] },
  { "type": "error", "name": "BorrowingNotPermittedBelowCT", "inputs": [] },
